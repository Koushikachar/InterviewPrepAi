export const CARD_BG = [
  { id: 1, bgcolor: "linear-gradient(135deg,#ef8f3 0% ,#f7fcfa 100%" },
  ...
  { id: 5, bgcolor: "linear-gradient(135deg,#e7f6f9 0% ,#f4fafd 100%" },
...
export const APP_FEATURES = [
  {
    ...
    description:
      " Get Interview questions and model based on your role, experience, and specific focus area - no",
  },
